...
if ($lang['id']!=$language) {
	$get_lang = file_get_contents('https://raw.githubusercontent.com/danielyzx123/hyuman/master/languages/' . $language . '.json');
	if (!empty($get_lang)) {
...
<div class="row3"><?php
	...
	echo fm_home().' | ver. '.$fm_version.' | <a href="https://github.com/danielyzx123/hyuman">Github</a>  | <a href="'.fm_site_url().'">.</a>';
